...
**Lidando com Arquivos ZIP**
  ...
  + Para descompactar o arquivo ZIP:  
      ...
      + Por padrão, os dados serão descompatados dentro de uma pasta como no BRA, semelhante ao nome do arquivo baixado, localizada no mesmo diretório onde o arquivo BRA.zip se encontra.
...
**OBS:** Metadados são informações adicionais que descrevem os dados principais. Eles podem incluir: descrição das variáveis; explicação do que cada coluna ou campo de dados representa; Unidades de medida: unidades usadas; ou seja, qualquer outra informação relevante que ajude a entender e utilizar os dados corretamente.
...
**Dicas Adicionais**  
  ...
  + Documentação: Leia a documentação ou notas técnicas fornecidas pela plataforma para entender melhor os dados e suas limitações.  
