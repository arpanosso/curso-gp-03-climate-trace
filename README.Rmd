...
knitr::opts_chunk$set(
  ...
  error = FALSE, message = FALSE,eval = FALSE,
  comment = "#>"
)
```
...
```{r echo=FALSE, out.width = "100%", fig.align = "left", fig.cap=""}
  knitr::include_graphics("img/luis-alan.png")
```
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/3cCNBWsF8x8?si=OfmtC9kqzNruVa7u&amp;start=742" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
